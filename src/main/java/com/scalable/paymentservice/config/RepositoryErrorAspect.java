package com.scalable.paymentservice.config;

import com.scalable.paymentservice.entity.BaseResponse;
...
public class RepositoryErrorAspect {
    ...
    @Around("execution(* com.scalable.paymentservice.controller..*(..))")
    ...
    private ResponseEntity<BaseResponse> buildResponse(HttpStatus status, String code, String message) {
        BaseResponse response = new BaseResponse(code, message);
